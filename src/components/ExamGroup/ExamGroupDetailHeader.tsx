// src/components/ExamGroup/ExamGroupDetailHeader.tsx
import React from "react";
import Link from "next/link";
import { ExamGroup } from "@/types/examGroup";
import styles from "@/app/exam-group/ExamGroup.module.css";

interface ExamGroupDetailHeaderProps {
  examGroup?: ExamGroup;
  totalExams: number;
}

export const ExamGroupDetailHeader = ({
  examGroup,
  totalExams,
}: ExamGroupDetailHeaderProps) => {
  return (
    <>
      <div className="mb-4">
        {/* Cập nhật link quay lại sang /exam-group */}
        <Link
          href="/exam-group"
